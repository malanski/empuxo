...
import viajanteLetra from '../../assets/viajante.png'
...
import qualehLetra from '../../assets/qualeh.png'
...
const trackFiles = [
    {
        ...
        lyrics: {
            partOne: <p>
                tua cara dizer que é pra relevar<br></br>
                e foi sem querer que caiu em cima<br></br>
                o nó da questão embaixo do pano<br></br>
                tu é que responde ao lixo que cativa<br></br>
                <br></br>
                eu vi você fazer essa bagunça<br></br>
                e não ais saber de fazer faxina<br></br>
                vai virar sertão se chover tão pouco<br></br>
                só mais uma dose o vicio é todo dia<br></br>
                <br></br>
            </p>,
            partTwo: <p>Sonha com o dia todo repetindo a resposta, de novo, a mesma resposta
                ...
                <br></br>
                <br></br>
                eu não vou correr nem ficar parado<br></br>
                se sobe vai desescer<br></br>
                num tempo intercalado<br></br>
                matar um leão todo dia é pouco<br></br>
                a paerpectiva é o que mais arrasa<br></br>
                <br></br>
                eu não vou temer sem nada no bolso<br></br>
                e no seu poder quem é submisso<br></br>
                no mesmo padrão receita de louco<br></br>
                já vi esse filme é tudo ladainha<br></br>
                <br></br>
            </p>,
        },
    },
    {
        ...
        lyrics:{partOne: <p>
            Sera que isso é mais um de seus testes<br></br>
            qu esmaga e empurra pra verm meus limites<br></br>
            então algózes viraram juízes<br></br>
            nem se sabe do que eles são capazes<br></br>
            <br></br>
            olha pra tras vê o horizonte e a fila não terminou<br></br>
            aumenta o passo ou a prença gigante esmagou<br></br>
            vai virar sertão se chover tão pouco<br></br>
            só mais uma dose o vicio é todo dia<br></br>
            <br></br>
        </p>,
        partTwo: <p>Na cabreiragem com os dois pés atras<br></br>
            uma moeda com duas caras<br></br>
            O lá quem ta enchendo as burras<br></br>
            zumbis domesticados em hordas<br></br>
            que carrega o trono nas costas<br></br>
            <br></br>
            olhar pra cima não da pela pressão<br></br>
            vê se não caia no chão<br></br>
            ê se não falha a missão<br></br>
            <br></br>
        </p>,
